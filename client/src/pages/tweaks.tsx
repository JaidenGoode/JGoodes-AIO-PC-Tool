...
const CATEGORIES = ["all", "performance", "gaming", "system"] as const;
            ...
            {filteredTweaks?.map((tweak) => {
              ...
              return (
                ...
                >
                  <div
                    className={cn(
                      "h-full flex flex-col p-4 rounded-xl border transition-all duration-200 relative overflow-hidden",
                      isOptimized
                        ? "bg-primary/5 border-primary/25"
                        : isSelected
                          ? "bg-primary/7 border-primary/35 cursor-pointer"
                          : "bg-card border-border/70 hover:border-primary/25 cursor-pointer"
                    )}
                    style={
                      isOptimized
                        ? { boxShadow: "0 0 24px hsl(var(--primary) / 0.14), inset 0 1px 0 hsl(var(--primary) / 0.1), 0 2px 14px rgba(0,0,0,0.35)" }
                        : isSelected
                        ? { boxShadow: "0 0 18px hsl(var(--primary) / 0.12), 0 2px 12px rgba(0,0,0,0.3)" }
