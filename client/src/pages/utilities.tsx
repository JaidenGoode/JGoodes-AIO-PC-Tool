...
export default function Utilities() {
  ...
  const launchShutUp10 = async () => {
    ...
    const script = [
      ...
      `  $dlOk = $false`,
      `  # Try Invoke-WebRequest first (handles TLS 1.2 reliably)`,
      `  try {`,
      `    Invoke-WebRequest -Uri $dlUrl -OutFile $tmpDest -UserAgent "Mozilla/5.0 (Windows NT 10.0; Win64; x64)" -UseBasicParsing -TimeoutSec 120 -EA Stop`,
